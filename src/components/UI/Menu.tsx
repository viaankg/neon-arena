    ...
    <div className="absolute inset-0 bg-black flex items-center justify-center p-8 overflow-hidden">
      ...
      >
        ...
        <div className="w-full md:w-72 space-y-6">
          ...
          <div className="mt-12 pt-8 border-t border-white/5 flex flex-col gap-2 text-[10px] text-zinc-600 uppercase tracking-widest">
            <div className="flex justify-between">
              <span>v1.0.5-stable</span>
              <span>System Ready</span>
            </div>
            <div className="text-cyan-500/50">Map: {selectedMap}</div>
          </div>
        </div>
      </motion.div>
    </div>
